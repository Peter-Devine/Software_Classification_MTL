...
parser.add_argument('--batch_size_train', default=84, type=int, help='Number of epochs to train the model for')
parser.add_argument('--batch_size_eval', default=84, type=int, help='Number of epochs to train the model for')
