...
def get_outdomain_single_task_results(results_dict, logger):
    ...
    for i, dataset in enumerate(dataset_names):
        ...
        for dnn_dataset_run, classical_dataset_run in zip(dnn_dataset_runs, classical_dataset_runs):
    ...
    assert all([x in dnn_run_values.keys() for x in classical_run_values.keys()])
