...
class BaselineModels:
    def __init__(self, random_state):
        self.model_dict = {
            ...
            "Bagging support vector classifier C 0.1": partial(BaggingClassifier, base_estimator=SVC(random_state=random_state, C=0.1), n_estimators=10, max_samples=0.1, random_state=random_state),
            "Bagging support vector classifier C 0.5": partial(BaggingClassifier, base_estimator=SVC(random_state=random_state, C=0.5), n_estimators=10, max_samples=0.1, random_state=random_state),
            "Bagging support vector classifier C 1": partial(BaggingClassifier, base_estimator=SVC(random_state=random_state, C=1), n_estimators=10, max_samples=0.1, random_state=random_state),
            "Bagging support vector classifier C 2": partial(BaggingClassifier, base_estimator=SVC(random_state=random_state, C=2), n_estimators=10, max_samples=0.1, random_state=random_state),
            "Bagging support vector classifier C 5": partial(BaggingClassifier, base_estimator=SVC(random_state=random_state, C=5), n_estimators=10, max_samples=0.1, random_state=random_state),
