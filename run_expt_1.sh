...
for dataset in ${datasets[@]}; do
	for random_state in ${random_states[@]}; do
	        ...
	        python software_feedback_cls.py --dataset_list=$dataset --random_state=$random_state --output_text --do_classical --num_epochs=60 --num_fine_tuning_epochs=60 --early_stopping_patience=10 --batch_size_train=48 --batch_size_eval=48 --max_length=128 --neptune_username=$1
	done
done
